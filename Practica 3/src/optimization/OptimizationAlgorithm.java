...
public abstract class OptimizationAlgorithm {
    ...
    // Methods
    /**
     * Evaluates a configuration. Also stores and returns its score, and increments the number of evaluated configurations.
     */
    ...
    public void showResults() {
        ...
        if (searchTime < 1000) {
            ...
            System.out.println("Search time: " + (double)searchTime/1000 + " seconds.");
        }
        showAlgorithmStats();
    }
