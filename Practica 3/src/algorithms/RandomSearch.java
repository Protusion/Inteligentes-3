...
/**
 * Implements random search. Generates several random configurations and stores the best.
 */
public class RandomSearch extends OptimizationAlgorithm {
    ...
    /**
     * Displays the statistics of the search. In this case, only the number of random solutions that have been generated.
     */
    @Override
