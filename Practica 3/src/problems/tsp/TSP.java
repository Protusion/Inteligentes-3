...
/**
 * Implements a version of the classical TSP. The agent begins the tour in a random-initial position and must reach the exit after visiting all cities once. The size of the problem corresponds to the number of cities.
 */
